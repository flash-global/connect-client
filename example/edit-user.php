...
$user = (new User())
    ->setUserName('testEdit')
    ->setEmail('test@test.com')
    ->setFirstName('testEditFirstName')
    ->setLastName('testEditLastName');
...
$newUser = clone($user);
echo "##### EDITING A USER ######" . PHP_EOL;

try {
    print_r($userAdmin->edit($user, $newUser->setUserName('testEdit2')));
} catch (\Exception $e) {
    echo $e->getMessage();
}
